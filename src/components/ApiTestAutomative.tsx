...
export const ApiTestAutomative: React.FC<ApiTestProps> = ({
  endpoint,
  title,
  description,
}) => {
  const { data, error, isLoading, dataUpdatedAt } = useApiGet<TestResponse>(
    endpoint,
    ['api-test-automative', endpoint],
    {
          ...
          {response && (
            <div className="bg-green-50 border border-green-200 rounded-md p-3">
              ...
              <div className="text-sm text-green-700">
                <p className="mb-2">
                  Status:{' '}
                  {response.status !== undefined ? response.status : 'N/A'}
                </p>

                {/* Classification Table */}
                {response &&
                  'standings' in response &&
                              ...
                              >
                                ...
                                <td className="px-4 py-2 text-sm text-gray-900">
                                  {standing.total_time_ms
                                    ? formatTime(standing.total_time_ms)
                                    : 'N/A'}
                                </td>
                                <td className="px-4 py-2 text-sm text-gray-900">
                                  {standing.gap_ms
                                    ? formatTime(standing.gap_ms)
                                    : 'N/A'}
                                </td>
                                <td className="px-4 py-2 text-sm text-gray-900">
